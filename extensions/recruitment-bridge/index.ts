 ...
 *
 * Cầu nối trung tâm giữa VClaw UI và kỹ năng head-hunter chạy trong Gateway:
 *   - head-hunter → Playwright / CDP (Tìm kiếm ứng viên, gửi tin nhắn, đăng bài qua trình duyệt thật)
 */
